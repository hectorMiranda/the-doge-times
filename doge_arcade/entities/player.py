import arcade
from settings.config import ASSETS_PATH, LEFT_FACING, SPRITE_DEATH_FRAMES,SPRITE_CLIMB_FRAMES, SPRITE_IDLE_FRAMES, SPRITE_RUN_FRAMES, SPRITE_SPAWN_FRAMES, SPRITE_SIZE_WIDTH, SPRITE_SIZE_HEIGHT
