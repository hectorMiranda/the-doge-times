import arcade
import arcade.gui
from settings.constants import STATUS_BAR_ITEM_BOX_WIDTH, STATUS_BAR_ITEM_BOX_HEIGHT, STATUS_BAR_MENU_ITEM_WIDTH, STATUS_BAR_MENU_ITEM_HEIGHT, TRANSLUCENT_BACKGROUND_COLOR   
import math
import time
